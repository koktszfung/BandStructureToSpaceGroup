...
if __name__ == '__main__':
    ...
    function_analysis.get_counts(230, "list/guess/spacegroup_list_{}.txt", json2inputlabel)
    ...
    #     return data_label_np
    # function_analysis.get_counts(7, "list/guess/crystal_list_{}.txt", json2inputlabel)
